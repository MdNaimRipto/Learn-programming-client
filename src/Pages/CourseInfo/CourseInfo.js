...
const CourseInfo = () => {
    ...
    const { img, id, courseName, aboutCourse, learnings, skills } = courseInfo
    return (
            ...
            <div className="gridCard">
                ...
                <div className="flex flex-col justify-center">
                    <div className="max-w-xl mb-6">
                        <h2 className="max-w-lg mt-4 mb-8 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
                            {courseName}
